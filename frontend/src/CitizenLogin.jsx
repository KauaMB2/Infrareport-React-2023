...
const Login=({loggedIn, setLoggedIn, userEmail, userPassword, setEmail, setPassword})=>{
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch("http://127.0.0.1:8000/login/citizen", {
                method: "POST",
                headers: {
            ...
            if (!response.ok) {
                ...
                alert("Senha ou email incorrretos.")
